...
# tput is a command to manipulate the terminal, it can be used to change the color of text, apply effects, and generally brighten thi
ngs up.
...
# Write a greeting
tput setaf 79; tput bold
tput cup $lin $((c - 20)); echo Ramon  wishes you all AWZARs Merry Christmas
